  ...
  return (
    <div className="relative w-full h-full flex items-center justify-center overflow-visible">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-48 h-48 flex items-center justify-center z-10">
        ...
        {/* Background glow */}
        <div className="absolute w-72 h-72 bg-orange-600/20 rounded-full blur-[50px] z-0 pointer-events-none" />

        {/* Accretion Disk (BACK HALF) */}
        <div className="absolute w-[450px] h-[130px] rounded-[50%] border-[2px] border-orange-500/50 z-0 shadow-[0_0_30px_rgba(249,115,22,0.4)] pointer-events-none" 
             style={{ clipPath: 'polygon(0 0, 100% 0, 100% 50%, 0 50%)' }} />

        {/* The Black Core */}
        <div className="absolute w-44 h-44 rounded-full bg-[#030100] z-10 shadow-[0_0_50px_rgba(249,115,22,0.3),inset_0_0_20px_rgba(0,0,0,1)] border border-orange-500/20" />

        {/* Accretion Disk (FRONT HALF) */}
        <div className="absolute w-[450px] h-[130px] rounded-[50%] border-[3px] border-orange-300 z-20 shadow-[0_0_40px_rgba(249,115,22,0.8),inset_0_0_20px_rgba(249,115,22,0.5)] pointer-events-none blur-[0.5px]" 
             style={{ clipPath: 'polygon(0 50%, 100% 50%, 100% 100%, 0 100%)' }} />
        
        {/* Bright inner core for front half */}
        <div className="absolute w-[450px] h-[130px] rounded-[50%] border-[4px] border-white z-20 shadow-[0_0_20px_rgba(255,255,255,0.8)] pointer-events-none blur-[1px]" 
             style={{ clipPath: 'polygon(0 50%, 100% 50%, 100% 100%, 0 100%)', transform: 'scale(0.98)' }} />

        {/* Horizontal flares (Doppler effect) */}
        <div className="absolute w-[500px] h-[2px] bg-gradient-to-r from-transparent via-orange-400/80 to-transparent z-20 blur-[2px] pointer-events-none" />
        <div className="absolute w-[350px] h-[1px] bg-gradient-to-r from-transparent via-white to-transparent z-20 pointer-events-none" />

        {/* Text over Black Hole */}
        <div className="absolute z-30 flex flex-col items-center justify-center pointer-events-none" style={{ transform: 'translateY(-5px)' }}>
          <span className="text-white text-5xl font-bold tracking-tight drop-shadow-[0_2px_10px_rgba(0,0,0,1)]">200+</span>
          <span className="text-white/80 text-[10px] mt-1 uppercase tracking-widest font-bold drop-shadow-[0_2px_10px_rgba(0,0,0,1)]">Client Projects</span>
        </div>
      </div>
